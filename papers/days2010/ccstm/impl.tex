...
CCSTM's implementation is modeled on SwissTM~\cite{dragojevic09swisstm}.  Version
...
\ytype{Array}{\xtype{Ref}{A}}.  \todo{revisit}  In some cases these storage optimizations
...
then revalidating.  \todo{why?} To limit the potential impact of these booby-trapped
...
its current implementation, CCSTM uses many of the \type{Atomic*} classes
