...
This is because Deuce STM never yields, sleeps, or blocks, which avoids 
the cost of context switches.  At thread counts 32 and 64, however, threads must
...
the overhead imposed by the library-based design.  They do demonstrate,
