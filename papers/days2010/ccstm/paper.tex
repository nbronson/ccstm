...
\lstdefinelanguage{Scala}{
  ...
  morecomment=[l]{//},
  morecomment=[s]{/*}{*/},
  morekeywords={var,val,def,private,class,object,implicit,if,else,new,do,while,@volatile,try,catch,case,match,throw,return,extends,with}
}
...
%  basicstyle=\selectfont\tt,
  ...
  emph={[2]Unit,Int,Set,Map,TSet,TMap,TVar,Option,Boolean,Txn,Money,Account,OverdraftException}, emphstyle={[2]\itshape}
}
