...
\newcommand{\xtype}[1]{{\selectfont\tt\itshape #1}}
\newcommand{\xtypey}[2]{{\selectfont\tt{\itshape #1}[{\itshape\bfseries #2}]}}
\newcommand{\xtypeparam}[1]{{\selectfont\tt\itshape #1}}
\newcommand{\xtypeA}[1]{{\xtypey{#1}{A}}}
\newcommand{\xcode}[1]{{\selectfont\tt #1}}
\newcommand{\xkeyword}[1]{{\selectfont\tt\bfseries #1}}
